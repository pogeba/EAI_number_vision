...
void setTimer(){
    ...
    while(true){
        ...
        if(cur_time - lastTime >= (5*CLOCKS_PER_SEC/100)) {
            lastTime = cur_time;
            if(turned) {
                adjustDirection();
            } else {
...
//        return;
 //   }
    ...
    usleep(700000);
    UART_Send(fd,send_buf_stop,7);
    usleep(500000);

//  char send_buf_turn[11]="z 3 -3;\r";
  char send_buf_turn[11] = {'z',' ','1','0',' ','-','1','0',';','\r'};
    if(type == 4) {
...
//    char send_buf7[11]="z 10 -10;\r";
 ...
 //   usleep(5000000);
 //   UART_Send(fd,send_buf8,7);
  //  usleep(2000000);
//    UART_Send(fd,send_buf7,10);
    sLock.unlock();
}
